							...
							<div class="card-body">
								<form action="<?php echo site_url('admin/products/add') ?>" method="post" enctype="multipart/form-data" >
									...
									<div class="form-group">
										...
										<input class="form-control <?php echo form_error('price') ? 'is-invalid':'' ?>"type="number" name="stock" min="0" placeholder="Stock product" />
										<div class="invalid-feedback">
											<?php echo form_error('price') ?>
										</div>
									</div>
									<div class="form-group">
										...
										<input class="form-controlfile <?php echo form_error('price') ? 'is-invalid':'' ?>"type="file" name="image" />
										<div class="invalid-feedback">
